        ...
        <el-card class="mb-20">
            <el-form :inline="true" :model="query" size="mini">
                <el-form-item label="字典名称">
                    <el-input v-model="query.dict_name" placeholder="字典名称" />
                </el-form-item>
                <el-form-item label="字段类型">
                    <el-input v-model="query.dict_type" placeholder="字段类型" />
                </el-form-item>
        ...
        <el-card>
            ...
            <div>
                ...
                >
                    ...
                    <el-table-column prop="dict_name" label="字段名称" />
                    <el-table-column prop="dict_type" label="字段类型">
...
export default {
    ...
    methods: {
        ...
        deleteDictType(index, row) {
            this.$confirm(`删除字段名称【${row.dict_name}】, 是否继续?`, '删除', {
