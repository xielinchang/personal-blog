    ...
    <div class="role">
        <el-card>
            <div style="text-align: left;" class="mb-20">
                <el-button icon="el-icon-plus" type="primary" size="mini" @click.native="addRole">添加</el-button>
            </div>
            <div>
        ...
        <el-dialog :visible.sync="authDialogShow" title="权限" width="30%" @open="treeOpen">
            <el-tree
                ref="tree"
                :data="authData"
                show-checkbox
