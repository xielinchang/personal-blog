...
<script>
import TitleLine from '../joy-design/Title-Line.vue'
import { recordQuery } from '../../../api/api'
import MyWhether from '../joy-design/baidu-whether.vue'
export default {
  name: 'RTab',
  components: {
    TitleLine,
  ...
  data() {
    return {
      name: 'Coisíní',
      saying: '爱尔兰语Coisíní，翻译过来意为“怦然心动”',
      record_list: []
    }
  },
  mounted() {
